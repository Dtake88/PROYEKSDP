        ...
        <div class="widget-content nopadding">
          <form action="#" method="get" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="Nama Mata Pelajaran" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">KKM :</label>
              <div class="controls">
                <input type="text"  class="span11" placeholder="KKM"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Tingkat Mata Pelajaran :</label>
              <div class="controls">
                <input type="number"  class="span11" placeholder="Tingkatan Mata Pelajaran"  />
              </div>
            </div>
